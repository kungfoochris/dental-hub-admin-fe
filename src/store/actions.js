...
export default {
    ...
    //     return axios
    //       .get('http://192.168.1.69:6061/api/v1/profile', {})
    //       .then(response => {
    //           commit('setProfile',response.data)
    //       })
    //       .catch(error=>{
    //         if (error.response.status==401){
    //           window.192.168.1.69.replace("/logout");
    //         }
    //       })
    //   },
      ...
      updateProfile({state,commit}, updateprofile){
        axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
        return axios
        .put('http://192.168.1.69:6061/api/v1/profile/update', updateprofile)
        .then(response => {
      ...
      listUsers({commit}){
        axios.defaults.headers.common['authorization'] = 'JWT '+ this.state.token
        return axios
          .get('http://192.168.1.69:6061/api/v1/users', {})
          .then(response => {
      ...
      listActivitie({commit}){
        axios.defaults.headers.common['authorization'] = 'JWT '+ this.state.token
        return axios
          .get('http://192.168.1.69:6061/api/v1/events', {})
          .then(response => {
      ...
      createUser({state,commit}, user_obj){
        axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
        return axios
        .post('http://192.168.1.69:6061/api/v1/users', user_obj)
        .then(response => {
      ...
      updateUser({state,commit}, user_obj){
        axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
        return axios
        .put('http://192.168.1.69:6061/api/v1/users/'+user_obj.id, user_obj)
        .then(response => {
          if(response.status==200){
            commit("setSuccessMessage",'success')
            state.users.push(response.data);
      ...
      deleteUser({state,commit},user_id){
        axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
        return axios
        .delete('http://192.168.1.69:6061/api/v1/users/'+user_id)
        .then(response => {
      ...
      listGeography({commit}){
        axios.defaults.headers.common['authorization'] = 'JWT '+ this.state.token
        return axios
        .get('http://192.168.1.69:6061/api/v1/geography', {})
        .then(response => {
      ...
      createGeography({state,commit}, geography_obj){
        axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
        return axios
        .post('http://192.168.1.69:6061/api/v1/geography', geography_obj)
        .then(response => {
          commit("setSuccessMessage",'success')
      ...
      updateGeography({commit}, geography_obj){
        axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
        return axios
        .put('http://192.168.1.69:6061/api/v1/geography/'+ geography_obj.id, geography_obj)
        .then(response => {
          commit("setSuccessMessage",'success')
        })
        .catch(error => {
      ...
      deleteGeography({state,commit},geography_id){
        axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
        return axios
        .delete('http://192.168.1.69:6061/api/v1/geography/'+geography_id)
        .then(response => {
          if(response.status==204){
            commit("setSuccessMessage",'success')
            state.geography.push(response.data);
      ...
      listActivity({commit}){
        axios.defaults.headers.common['authorization'] = 'JWT '+ this.state.token
        return axios
        .get('http://192.168.1.69:6061/api/v1/activities', {})
        .then(response => {
      ...
      createActivity({state,commit}, activity_obj){
        axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
        return axios
        .post('http://192.168.1.69:6061/api/v1/activities', activity_obj)
        .then(response => {
          commit("setSuccessMessage",'success')
      ...
      UpdateActivity({state,commit}, activity_obj){
        axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
        return axios
        .put('http://192.168.1.69:6061/api/v1/activities/'+activity_obj.id, activity_obj)
        .then(response => {
          commit("setSuccessMessage",'success')
          state.activities.push(response.data);
        })
      ...
      deleteActivity({state,commit},activity_id){
        axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
        return axios
        .delete('http://192.168.1.69:6061/api/v1/activities/'+activity_id)
        .then(response => {
          if(response.status==204){
            commit("setSuccessMessage",'success')
            state.geography.push(response.data);
      ...
      changePassword({commit}, password_obj){
        axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
        return axios
        .post('http://192.168.1.69:6061/api/v1/users/changepassword', password_obj)
        .then(response => {
          if(response.status==200){
          commit("setSuccessMessage",'success');
          }
      ...
      listVisualization({commit}){
        axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
        return axios
        .get('http://192.168.1.69:6061/api/v1/visualizations',)
        .then(response => {
          if(response.status==200){
    ...
    listAddress({commit}){
      return axios
      .get('http://192.168.1.69:6061/api/v1/addresses',)
      .then(response => {
        if(response.status==200){
    ...
    listRole({commit}){
      return axios
      .get('http://192.168.1.69:6061/api/v1/roles',)
      .then(response => {
        if(response.status==200){
    ...
    listLoginVisualization({commit}){
      return axios
      .get('http://192.168.1.69:6061/api/v1/loginvisualization',)
      .then(response => {
        if(response.status==200){
    ...
    listLoginVisualization1({commit}){
      return axios
      .get('http://192.168.1.69:6061/api/v1/loginvisualization1',)
      .then(response => {
        if(response.status==200){
    ...
    updateUserStatus({state,commit}, user_obj){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .post('http://192.168.1.69:6061/api/v1/userstatus/'+user_obj.userid,user_obj)
      .then(response => {
        if(response.status==200){
          var userdetail
    ...
    resetPassword({commit}, resetpassword_obj){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .post('http://192.168.1.69:6061/api/v1/adminresetpassword', resetpassword_obj)
      .then(response => {
        if(response.status==200){
          commit("setSuccessMessage",'success');
        }
    ...
    listOverview({commit}){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .get('http://192.168.1.69:6061/api/v1/overviewvisualization1',)
      .then(response => {
        if(response.status==200){
    ...
    listTreatmentbyActivity({commit}){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .get('http://192.168.1.69:6061/api/v1/treatmentactivities',)
      .then(response => {
        if(response.status==200){
    ...
    listTreatmentbyWard({commit}){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .get('http://192.168.1.69:6061/api/v1/overviewwardtreatmenttable',)
      .then(response => {
        if(response.status==200){
    ...
    listTreatmentTableBasicData({commit}){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .get('http://192.168.1.69:6061/api/v1/treatment',)
      .then(response => {
        if(response.status==200){
    ...
    listTreatmentTable({commit}){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .get('http://192.168.1.69:6061/api/v1/treatmenttable',)
      .then(response => {
        if(response.status==200){
    ...
    listTreatmentStrategicData({commit}){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .get('http://192.168.1.69:6061/api/v1/treatmentstrategicdatas',)
      .then(response => {
        if(response.status==200){
    ...
    listVisualizationSettings({commit}){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .get('http://192.168.1.69:6061/api/v1/settingsgraph',)
      .then(response => {
        if(response.status==200){
    ...
    listWards({commit}){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .get('http://192.168.1.69:6061/api/v1/wards',)
      .then(response => {
        if(response.status==200){
    ...
    listUserWards({commit}){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .get('http://192.168.1.69:6061/api/v1/userwards',)
      .then(response => {
        if(response.status==200){
    ...
    updateWard({state,commit}, ward_id_obj){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .put('http://192.168.1.69:6061/api/v1/wards/'+ward_id_obj.id, ward_id_obj)
      .then(response => {
    ...
    listSectionalTable({commit}){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .get('http://192.168.1.69:6061/api/v1/sectional',)
      .then(response => {
        if(response.status==200){
    ...
    listTreatmentBarVisualizationChart({commit}){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .get('http://192.168.1.69:6061/api/v1/treatmentnargraph',)
      .then(response => {
        if(response.status==200){
    ...
    listTreatmentPreventionRatio({commit}){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .get('http://192.168.1.69:6061/api/v1/preventionratio',)
      .then(response => {
        if(response.status==200){
    ...
    listEarlyIntervention({commit}){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .get('http://192.168.1.69:6061/api/v1/earlyintervention',)
      .then(response => {
        if(response.status==200){
    ...
    listRecallDistribution({commit}){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .get('http://192.168.1.69:6061/api/v1/recalldistribution',)
      .then(response => {
        if(response.status==200){
    ...
    listWardLineVisualizationChart({commit}){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .get('http://192.168.1.69:6061/api/v1/wardlineVisualization',)
      .then(response => {
        if(response.status==200){
    ...
    CreateOverViewVisualization({commit}, overviewvisualization_obj){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .post('http://192.168.1.69:6061/api/v1/overviewvisualization1', overviewvisualization_obj)
      .then(response => {
        if(response.status==200){
          commit("setOverview",response.data);
    ...
    CreateTreatmentBarVisualization({commit}, overviewvisualization_obj){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .post('http://192.168.1.69:6061/api/v1/settingsgraphfilter', overviewvisualization_obj)
      .then(response => {
        if(response.status==200){
          commit("setVisualizationSettings",response.data);
          // state.table1_obj.update(response.data);
    ...
    CreateWardLineVisualization({commit}, overviewvisualization_obj){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .post('http://192.168.1.69:6061/api/v1/wardlineVisualizationfilter', overviewvisualization_obj)
      .then(response => {
        if(response.status==200){
          commit("setWardLineVisualizationChart",response.data);
          // state.table1_obj.update(response.data);
    ...
    CreateTreatmentPageBarVisualization({commit}, overviewvisualization_obj){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .post('http://192.168.1.69:6061/api/v1/treatmentnargraphfilter', overviewvisualization_obj)
      .then(response => {
        if(response.status==200){
          commit("setTreatmentBarVisualizationChart",response.data);
          // state.table1_obj.update(response.data);
    ...
    CreateTreatmentPageGenderVisualization({commit}, overviewvisualization_obj){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .post('http://192.168.1.69:6061/api/v1/visualizationsfilter', overviewvisualization_obj)
      .then(response => {
        if(response.status==200){
          commit("setVisualization",response.data);
          // state.table1_obj.update(response.data);
    ...
    CreateTreatmentBasicDataTable({commit}, overviewvisualization_obj){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .post('http://192.168.1.69:6061/api/v1/treatmentfilter', overviewvisualization_obj)
      .then(response => {
        if(response.status==200){
    ...
    CreateTreatmentPageTreatmentTable({commit}, overviewvisualization_obj){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .post('http://192.168.1.69:6061/api/v1/table2filter', overviewvisualization_obj)
      .then(response => {
        if(response.status==200){
    ...
    CreateTreatmentStrategicData({commit}, overviewvisualization_obj){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .post('http://192.168.1.69:6061/api/v1/table3filter', overviewvisualization_obj)
      .then(response => {
        if(response.status==200){
    ...
    CreateTableBasicDataVisualization({commit}, overviewvisualization_obj){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .post('http://192.168.1.69:6061/api/v1/treatment', overviewvisualization_obj)
      .then(response => {
        if(response.status==200){
          commit("setTreatmentTableBasicData",response.data);
          // state.table1_obj.update(response.data);
    ...
    CreateStrategicDataVisualization({commit}, overviewvisualization_obj){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .post('http://192.168.1.69:6061/api/v1/treatmentstrategicdatas', overviewvisualization_obj)
      .then(response => {
        if(response.status==200){
          commit("setTreatmentStrategicData",response.data);
          // state.table1_obj.update(response.data);
