...
export default {
    ...
    listTreatmentLineVisualizationChart({commit}){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .get('http://192.168.1.69:6061/api/v1/treatmentvisualizationlinechart',)
      .then(response => {
        if(response.status==200){
    ...
    listTreatmentLineVisualizationChart1({commit}){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .get('http://192.168.1.69:6061/api/v1/treatmentvisualizationlinechart1',)
      .then(response => {
        if(response.status==200){
    ...
    listTreatmentLineVisualizationChart2({commit}){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .get('http://192.168.1.69:6061/api/v1/treatmentvisualizationlinechart2',)
      .then(response => {
        if(response.status==200){
